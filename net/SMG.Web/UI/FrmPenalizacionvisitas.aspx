<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" MasterPageFile="~/UI/MasterPageMntoGasSinMenuFacturacionAverias.master" CodeFile="FrmPenalizacionvisitas.aspx.cs" Inherits="Iberdrola.SMG.UI.FrmPenalizacionvisitas" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="FrmFacturacionVisitas" ContentPlaceHolderID="ContentPlaceHolderContenido" runat="server">
    ...
    <div id="divTituloVentana">
        <asp:Label CssClass="divTituloVentana" ID="lblTituloVentana" runat="server" 
            Text="Visitas Bonificadas/Penalizadas" 
            ...
            <div style="position:absolute; top: 34px; left: 5px; width: 760px; height: 61px;" 
                ...
                <asp:Panel ID="Panel2" CssClass="labelFormulario" runat="server" 
                    ...
                    <asp:RadioButtonList ID="rdbBusquedas0" runat="server" 
                        ...
                        <asp:ListItem Value="3" meta:resourcekey="ListItemResource1">Visitas Bonificables</asp:ListItem>
                        <asp:ListItem Value="4" meta:resourcekey="ListItemResource2">Visitas Penalizables</asp:ListItem>
                    </asp:RadioButtonList>
                </asp:Panel>
            </div>
                    ...
                    meta:resourcekey="grdListadoResource1" >
                         <Columns>
                            <asp:TemplateField meta:resourcekey="TemplateFieldResource1">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSeleccionar" runat="server"  ToolTip="Seleccionar" 
                                        CommandName="Seleccionar" CssClass="campoFormulario" 
                                        meta:resourcekey="chkSeleccionarResource1" />
                                </ItemTemplate>    
            ...
            <div style="position:absolute; top: 102px; left: 5px; width: 760px; height: 61px;">
                <asp:Panel ID="Panel1" CssClass="labelFormulario" runat="server" 
                    ...
                    <asp:RadioButtonList ID="rdbBusquedas" runat="server" 
                        ...
                        <asp:ListItem Value="3" meta:resourcekey="ListItemResource3">Visitas Bonificadas</asp:ListItem>
                        <asp:ListItem Value="4" meta:resourcekey="ListItemResource4">Visitas Penalizadas</asp:ListItem>
                    </asp:RadioButtonList>
                </asp:Panel>
            </div>
        </ContentTemplate>
