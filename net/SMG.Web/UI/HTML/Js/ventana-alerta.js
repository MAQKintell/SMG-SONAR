...
cerrarVentana: function () {
		parent.document.getElementById('cboSituaciones').value=1;
		this.ventana.style.display = "none";
		this.csombra.style.display = "none";
		this.fondo.style.display = "none";
	},
	...
	crear: function() {
		...
		this.fondo.style.background = "black";
...
function abrirVentanaAlerta(pagina, ancho, alto, nombre,titulo,cambiofondo) {
    VentanaModal.inicializar();
    var html = ""
    html += "<table cellpadding='3' cellspacing='0' border='1' class='ventana-modal-Alerta'>"
    html += "<tr><td>"
    html += "<iframe name='" + nombre + "' src='" + pagina + "' width='100%' height='" + (parseInt(alto) - 30) + "' frameborder='0'></iframe>"
    html += "</td></tr></table>";
