...
*/
	...
	this.size_div.style.left = "0px";
	this.size_div.style.top = "0px";
...
RichCalendar.prototype.show_at_position = function(el, x, y) {
	this.show(x, y, el, null);
...
RichCalendar.prototype.text = function(name, language) {
	...
	return typeof(RichCalendar.rc_lang_data[0][name]) != "undefined"?RichCalendar.rc_lang_data[0][name]:'';
...
var en_month_names = this.text('monthNames', 'es');
var en_short_month_names = this.text('monthNamesShort', 'es');
