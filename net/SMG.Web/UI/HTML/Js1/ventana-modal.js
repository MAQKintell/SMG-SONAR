...
var VentanaModal = {
	...
	crear: function() {
		...
		this.ventana.style.height = this.alto + "px";
		this.ventana.className = this.claseVentana;
		//this.ventana.onfocus = function foco(){alert();}
		this.ventana.onblur = function foco(){setTimeout("self.focus()",100)};
...
function abrirVentanaLocalizacion(pagina, ancho, alto, nombre,titulo,cambiofondo,FondosiNo) {
    ...
    var html = ""
    //if (cambiofondo=="1"){
	//	 html += "<table cellpadding='3' cellspacing='0' border='0' style='background:black;font-color:red;border:2px solid whitesmoke;width:100%;height:100%;'><tr><td style='border-bottom: 2px solid white;' align='right'>"
	//}
    //else{
	//	html += "<table cellpadding='3' cellspacing='0' border='0' class='ventana-modal-ventana'><tr><td class='ventana-modal-barra' align='right'>"
	//}
	html += "<table cellpadding='3' cellspacing='0' border='0' class='ventana-modal-ventana'><tr><td class='ventana-modal-barra' align='right' width='100%'>"
	//if (cambiofondo=="1"){
	//	html += "<center><b><font color='#EBC956'>" + titulo + "</font></b></center>"
    //}
    //else{
    ...
    /*html += "<tr><td>";
    html +="<table width='100%' cellpadding='0' cellspacing='0' class='cabeceraCentroModal'>";
		html +="<tr><td class='cabeceraIzdaModal'></td><td class='cabeceraCentroModal' align='left'><img src='HTML/Images/logoIberdrola.jpg' alt='logo IBERDROLA'/></td><td></td><td class='textoTituloCabeceraModal'> - " + titulo + " - </td>";
        html +="<td class='cabeceraDchaModal'></td></tr></table>";
    html += "</td></tr>";*/
    html += "</td></tr></table>";
