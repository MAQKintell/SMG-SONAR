...
var LiferayDock = {
    ...
    initialize: function(defaultText) {
        ...
        if (myPlaces != null) {
            if (myPlaces.getElementsByTagName("table").length > 0) {
                ...
                if (count <= item.constants.lastFrame) {
                    ...
                    if (collapse) {
                        ...
                        if (cached) {
                            ...
                            //PARA K SALGA POR LA DERECHA.
                            //if(item.constants.x<0){
                            //    item.constants.x=item.constants.x * -1;}

                            //PARA K SALGAN EN LA MISMA LINEA.
                            item.constants.x = 0;
                            if (index == "1") {
                                item.constants.y = 60;
                                //    item.constants.x=20;
                            ...
                            if (index == "2") {
                                item.constants.y = 120;
                                //    item.constants.x=40;
                            }
                            if (index == "3") {
                                item.constants.y = 180;
                                //    item.constants.x=60;
                            }
                            if (index == "4") {
                                item.constants.y = 240;
                                //    item.constants.x=80;
                            }
                            if (index == "5") {
                                item.constants.y = 300;
                                //    item.constants.x=100;
                            }
                            if (index == "6") {
                                item.constants.y = 360;
                                //    item.constants.x=120;
                            }
                            //**************************************************************
                            item.style.left = (distRatio * (item.constants.x / Math.sin(maxRad))) + "px";
                            //item.style.left = (distRatio * (0/Math.sin(maxRad))) + "px";
