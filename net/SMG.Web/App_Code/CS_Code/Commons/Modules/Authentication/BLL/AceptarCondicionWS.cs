...
namespace Iberdrola.Commons.Modules.Authentication.BLL
{
    ...
    /// </summary>
    public class AceptarCondicionWS : AceptarCondicionWSService
    {
        protected override System.Net.WebRequest GetWebRequest(Uri uri)
        {
            ...
            ConfiguracionDTO uriCN = Configuracion.ObtenerConfiguracion(Enumerados.Configuracion.ARQ_COND_ACEPTADAS_URI);
