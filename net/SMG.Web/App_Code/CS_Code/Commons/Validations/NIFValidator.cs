    ...
    public class NIFValidator
    {
        ...
        private void Desglosa()
        {
            ...
            else
            {
                ...
                else if (tipo == TiposCodigosEnum.NIE)
                {
        ...
        /// </returns>
        public static NIFValidator CompruebaNif(string numero)
        {

            return new NIFValidator(numero);
        }
